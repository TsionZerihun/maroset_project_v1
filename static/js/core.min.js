...
function relativeUrl(t) {
    ...
    return o.href = t, e.origin != o.origin ? o.href : e.pathname != o.pathname || e.search != o.search ? o.pathname + o.search + o.hash : e.href == o.href ? o.hash || o.pathname + o.search + o.hash : o.hash
}
...
function getFigureValueByUrl(t) {
    ...
    if (e = t.match(/^(https?):\/\/(www\.)?vimeo\.com\/(\d+)/i)) return {
        embed: "/embed/vimeo?url=" + encodeURIComponent(t)
    };
    if (e = t.match(/^(https?):\/\/(www\.|mobile\.)?twitter\.com\/(.+)\/status\/(\d+)/i)) return {
        embed: "/embed/twitter?url=" + encodeURIComponent(t)
    };
    if (e = t.match(/^(https?):\/\/(t\.me|telegram\.me|telegram\.dog)\/([a-zA-Z0-9_]+)\/(\d+)/i)) return {
        embed: "/embed/telegram?url=" + encodeURIComponent(t)
    };
...
function _resizeIframe(t, e, o) {
    $("iframe").map(function() {
        ...
        if (l && l == t) {
            var i = o / e;
            this.setAttribute("width", "640"), this.setAttribute("height", Math.round(640 * i) + ""), this.parentNode && this.parentNode.classList.contains("iframe_helper") && (this.parentNode.style.paddingTop = 100 * i + "%"), window.quill && quill.updateSelection(Quill.sources.USER)
        }
    })
}
...
function initQuill() {
    ...
    function l(t, e, l) {
        var r = void 0,
            i = e.index;
        e.length > 0 && a.scroll.deleteAt(i, e.length);
        var n = o(i),
            s = !1,
            u = a.scroll.descendant(BreakBlot, i),
            c = _slicedToArray(u, 1);
        if (r = c[0])(!r.prev || r.prev instanceof BreakBlot) && (a.scroll.deleteAt(--i, 1), s = !0);
        else {
            var d = a.scroll.descendant(BreakBlot, i - 1),
                p = _slicedToArray(d, 1);
            r = p[0], r && (a.scroll.deleteAt(--i, 1), s = !0)
        }
        var h = a.scroll.descendant(SingleLineBlot, i),
            f = _slicedToArray(h, 1);
        if (r = f[0], r || s || !t) a.insertText(i, "\n", Quill.sources.USER), a.setSelection(++i, Quill.sources.USER), (l.format.blockHeader || l.format.blockSubheader || l.format.blockBlockquote || l.format.blockPullquote) && n && a.formatLine(i, 1, {
            blockHeader: !1,
            blockSubheader: !1,
            blockBlockquote: !1,
            blockPullquote: !1
            ...
            a.insertEmbed(i, "textBreak", !0, Quill.sources.USER);
            var _ = a.scroll.descendant(BreakBlot, i),
                m = _slicedToArray(_, 1);
            r = m[0], !r || r.next || r.prev && r.prev instanceof BreakBlot || (a.insertEmbed(++i, "textBreak", !0, Quill.sources.SILENT), a.setSelection(i, 0, Quill.sources.SILENT))
        }
                ...
                bindings: {
                    ...
                    "required enter": {
                        ...
                        handler: function(t, e) {
                            var o = this.quill.scroll.descendant(FieldBlot, t.index),
                                ...
                                r = l[0];
                            return r && r.next && !$(r.next.domNode).text() ? (this.quill.setSelection(r.next.offset(this.quill.scroll), 0, Quill.sources.USER), !1) : (this.quill.insertText(t.index, "\n", Quill.sources.USER), !1)
                        }
                    },
                    "required tab prev": {
                        key: Keyboard.keys.TAB,
                        ...
                        handler: function(t, e) {
                            ...
                            if (t.length > 0) {
                                ...
                                var r = a.scroll.descendant(Block, t.index),
                                    i = _slicedToArray(r, 1);
                                o = i[0]
                            }
                        ...
                        handler: function(t, e) {
                            ...
                            if (r) {
                                ...
                                if (u = s.match(/(^|\s)(https?:\/\/\S+)$/)) {
                                    var c = u[2],
                                        d = a.scroll.descendants(LinkBlot, t.index - c.length, c.length);
                                    if (d.length || a.formatText(t.index - c.length, c.length, "link", c, Quill.sources.USER), !s.substr(0, i - c.length).trim().length && "P" == r.domNode.tagName) {
                                        var p = getFigureValueByUrl(c);
                                        if (p) {
                                            var h = r.offset(a.scroll);
                    ...
                    "divider autofill": {
                        ...
                        handler: function(t, e) {
                            ...
                            if (r && "P" == r.domNode.tagName) {
                                var i = r.offset(a.scroll),
                                    n = (new Delta).retain(i)["delete"](r.length()).insert({
                                        blockDivider: !0
                                    });
                                return r.next || n.insert("\n"), a.updateContents(n, Quill.sources.USER), !1
                            }
                            return !0
                        }
                    },
                    ...
                    "list autofill": {
                        ...
                        handler: function(t, e) {
                            ...
                            this.quill.scroll.deleteAt(t.index - o, o), this.quill.formatLine(t.index - o, 1, "list", 1 === o ? "bullet" : "ordered", Quill.sources.USER), this.quill.setSelection(t.index - o, Quill.sources.SILENT)
                        }
                    },
                    "pre wrap": {
                        key: 192,
                        ...
                        handler: function(t, e) {
                            var o = e.prefix.length,
                                l = t.index - o;
                            this.quill.scroll.deleteAt(l, o), this.quill.formatLine(l, 1, "code-block", !0, Quill.sources.USER), this.quill.setSelection(l, Quill.sources.SILENT)
                        }
                    },
                    code: {
                        key: 192,
                        handler: function(t, e) {
                            if (!e.collapsed) {
                                ...
                                if (o.length > 1 || 1 == o.length && o[0] instanceof CodeBlock) return this.quill.format("code-block", !e.format["code-block"], Quill.sources.USER), !1;
                                var l = a.scroll.descendants(BreakBlot, t.index, t.length);
                                if (l.length) return this.quill.format("code-block", !e.format["code-block"], Quill.sources.USER), !1
                            }
                    ...
                    "figure delete": {
                        ...
                        handler: function(t, e) {
                            var o = a.scroll.line(t.index),
                                ...
                                r = l[0];
                            l[1];
                            return !(r && r.prev && r.prev instanceof FigureBlot) || (e.empty && a.deleteText(t.index, 1, Quill.sources.USER), a.setSelection(r.prev.offset(a.scroll)), !1)
                        }
                    },
                    "field backspace": {
                        key: Keyboard.keys.BACKSPACE,
    ...
    return a.addContainer($tl_link_tooltip.get(0)), a.addContainer($tl_tooltip.get(0)), a.addContainer($tl_blocks.get(0)), a.on(Quill.events.EDITOR_CHANGE, function(t, e) {
        if (t === Quill.events.SELECTION_CHANGE && a.isEnabled() && null != e) {
            ...
            var o = a.scroll.descendant(Block, e.index),
                ...
                r = l[0];
            l[1];
            0 === e.length ? (hideFormatTooltip(), null == r || r instanceof FieldBlot || r instanceof BlockquoteBlot || r instanceof PullquoteBlot || r instanceof CodeBlock || r instanceof ListItem || $(r.domNode).text().length ? hideBlocksTooltip() : showBlocksTooltip(e)) : (null == r || r instanceof TitleBlot ? hideFormatTooltip() : (showFormatTooltip(e), toolbarUpdate(e)), hideBlocksTooltip());
            var i = a.getFormat(e);
            $tl_article.toggleClass("title_focused", !(!i.blockTitle && !i.blockAuthor)), checkOncePlaceholder()
        }
    }), a.on(Quill.events.TEXT_CHANGE, function() {
        a.getSelection();
        checkRequiredBlots(a), checkBlotPlaceholder(a), checkOncePlaceholder(), draftSave()
    }), a.on(Quill.events.TEXT_PASTE, function() {
        var t = a.getSelection();
        t && r(t)
    }), a.on(Quill.events.SCROLL_OPTIMIZE, function(t) {
        t.forEach(function(t) {
            if ("childList" == t.type && !t.addedNodes.length && t.removedNodes.length) {
                var e = t.previousSibling,
                    o = t.nextSibling;
                if (!o && e && "BR" == e.tagName && "inline" == e.className) {
                    var l = document.createElement("br");
                    l.className = "inline", t.target.appendChild(l)
                } else !o || !e || "BR" == e.tagName && "inline" == e.className || "BR" != o.tagName || "inline" != o.className || o.nextSibling || o.parentNode && o.parentNode.removeChild(o)
            }
        })
    ...
    }), checkRequiredBlots(a), checkBlotPlaceholder(a), a
}
...
function checkRequiredBlots(t) {
    var e = t.scroll.lines(),
        ...
        l = o[0],
        r = o[1];
    if (l instanceof BlockEmbed) t.updateContents((new Delta).insert("\n", {
        blockTitle: !0
    }).insert("\n", {
        blockAuthor: !0
            ...
            blockTitle: !0
        }, Quill.sources.SILENT), r) {
        if (r instanceof BlockEmbed) {
            var i = r.offset(t.scroll);
            t.updateContents((new Delta).retain(i).insert("\n", {
                blockAuthor: !0
            }), Quill.sources.SILENT)
        } else if (!(r instanceof AuthorBlot)) {
            var a = r.offset(t.scroll);
            t.formatLine(a, 1, {
                blockAuthor: !0
            }, Quill.sources.SILENT)
        }
    ...
    if (c) {
        ...
        h.forEach(function(e) {
            var o = e.offset(t.scroll),
                l = e.length(),
                r = e.constructor.blotName;
            t.formatText(o, l, r, !1, Quill.sources.SILENT)
        })
    } else {
        var f = t.scroll.length();
        t.insertText(f, "\n", Quill.sources.SILENT)
    }
    var _ = t.scroll.lines();
    _.forEach(function(t, e) {
        "P" == t.domNode.tagName && (3 == _.length && 2 == e ? t.domNode.setAttribute("data-placeholder", "Your story...") : t.domNode.removeAttribute("data-placeholder"))
    })
}
...
function checkFigureBlots(t) {
    var e = quill.scroll.descendant(FigureBlot, t.index),
        ...
        l = o[0],
        r = quill.scroll.descendants(FigureBlot, 0, quill.scroll.length());
...
function updatePhoto(t, e) {
    return "image/jpg" == t.type || "image/jpeg" == t.type ? loadImage(t, function(o) {
        if ("error" === o.type) e(t);
        else if (o.toBlob) o.toBlob(function(t) {
            e(t)
        }, t.type);
        else {
...
function uploadDataToBlob(t) {
    for (var e = atob(t.base64_data), o = [], l = 0; l < e.length; l++) o.push(e.charCodeAt(l));
...
function _uploadFile(t, e, o, l) {
    var r = new FormData;
    r.append("file", uploadDataToBlob(t)), $.ajax({
        url: "/upload",
        type: "POST",
        data: r,
        cache: !1,
...
function wrapDomElement(t) {
    ...
    if (t.childNodes.length) {
        e.children = [];
        for (var o = 0; o < t.childNodes.length; o++) e.children.push(wrapDomElement(t.childNodes[o]))
    }
    return e
}
...
function showError(t) {
    $error_msg.text(t), clearTimeout($error_msg.to), $error_msg.addClass("shown"), $error_msg.to = setTimeout(function() {
...
function savePage() {
    ...
    if (t.length < 2) {
        ...
        var l = quill.scroll.descendants(TitleBlot, 0, quill.scroll.length()),
            r = _slicedToArray(l, 1),
            i = r[0];
        return quill.setSelection(i.offset(), i.length() - 1), quill.selection.scrollIntoView(), showError("Title is too small")
    }
    var a = $('img[src^="data:"],video[src^="data:"]');
    if (a.length) return showError("Upload in progress.\nPlease wait...");
    var n = getPageContent();
...
function checkAuth() {
    T.editable && $.ajax(T.apiUrl + "/check", {
        data: {
            page_id: T.pageId
        },
        type: "POST",
        ...
        success: function(t) {
            if (t.save_hash && (T.saveHash = t.save_hash), t.report_hash && (T.reportHash = t.report_hash, $tl_page_footer.addClass("tl_page_footer_visible")), (t.can_edit && T.saveHash || !T.pageId) && (t.short_name && $account.text(t.short_name), $tl_article.addClass("tl_article_editable")), !T.pageId && ($tl_article.addClass("tl_article_edit"), !draftGet() && t.author_name)) {
                ...
                var o = quill.scroll.descendants(AuthorBlot),
                    l = _slicedToArray(o, 1),
                    r = l[0];
                r && quill.updateContents((new Delta).retain(r.offset())["delete"](r.length()).insert(t.author_name, e), Quill.sources.USER)
            }
            if (t.auth_alert && t.short_name) {
                var i = '<i class="tl_alert_success"></i><h4>Success!</h4><p>You are now logged in as <b>' + htsc(t.short_name) + "</b> in this browser.</p>";
                t.migrate_count > 0 && t.migrate_hash ? (i += "<p>We can also add " + t.migrate_count + " Telegraph page" + (t.migrate_count > 1 ? "s" : "") + " from this browser to your account.</p>", showAlert(i, {
                    close_btn: "Skip",
                    submit_btn: "Add",
                    submit: function() {
...
function migratePages(t) {
    $.ajax(T.apiUrl + "/migrate", {
        ...
        success: function(t) {
            t.migrated_count > 0 ? showAlert('<i class="tl_alert_success"></i><h4>Success!</h4><p>Added <b>' + t.migrated_count + "</b> Telegraph page" + (t.migrated_count > 1 ? "s" : "") + ' to your account.</p><p>To see a list of your pages, talk to the <a href="https://t.me/telegraph" target="_blank">@Telegraph</a> bot on Telegram.</p>', {
                close_btn: "Continue"
            }) : hideAlert()
        }
    })
...
function updateEditableText(t, e) {
    "undefined" == typeof e && (e = isEdit()), e ? $(".editable_text:not(:has(.editable_input))", t).map(function() {
        var t = this.innerText,
            e = document.createElement("textarea");
        return e.classList.add("editable_input"), e.setAttribute("dir", "auto"), e.setAttribute("tabindex", "-1"), e.setAttribute("rows", "1"), e.value = t, t || this.classList.add("empty"), $(this).empty().append(e), autosize(e), e
...
function updateEditable(t) {
    if ($tl_article.toggleClass("tl_article_edit", t), updateEditableText(), window.quill && (quill.enable(t), t && quill.focus()), !t) {
        var e = $("h1", $tl_content),
            o = $("address", $tl_content),
            l = $("address a", $tl_content).attr("href");
        $("h1", $tl_header).text(e.text()), $("address a", $tl_header).text(o.text()), l ? $("address a", $tl_header).attr("href", l) : $("address a", $tl_header).removeAttr("href"), hideLinkTooltip(), hideFormatTooltip(), hideBlocksTooltip()
    }
}

function updateReportFormState() {
    var t = $report_form.get(0),
        e = !t.reason.value || "copyright" == t.reason.value;
    $report_form.toggleClass("copyright_selected", "copyright" == t.reason.value), $report_form.toggleClass("form_disabled", !!e), t.reason.value && t.comment.focus()
}

function sendReport() {
    if ($report_form.hasClass("form_disabled")) return !1;
    var t = $report_form.get(0);
    $report_popup.addClass("tl_popup_loading"), $.ajax(T.apiUrl + "/report", {
        data: {
            page_id: T.pageId,
            report_hash: T.reportHash,
            reason: t.reason.value,
            reason_text: t.comment.value
        },
        type: "POST",
        dataType: "json",
        xhrFields: {
        ...
        success: function(t) {
            $report_popup.removeClass("tl_popup_loading"), hidePopup(), showAlert('<i class="tl_alert_success"></i><h4>Report sent</h4><p>Telegraph moderators will review your report. Thank you!</p>', {
                close_btn: "Done"
            })
        }
    })
...
function showLinkTooltip(t, e) {
    if (isEdit()) {
        ...
        $tl_link_tooltip.text(decodeURI(e)), tooltipUpdatePosition($tl_link_tooltip, o, linkTTOptions), $tl_link_tooltip.hasClass("move_anim") || setTimeout(function() {
...
function showFormatTooltip(t) {
    isEdit() && ($tl_tooltip.removeClass("tooltip_prompt"), tooltipUpdatePosition($tl_tooltip, t, formatTTOptions), $tl_tooltip.hasClass("move_anim") || setTimeout(function() {
...
function showAlert(t, e) {
    e = e || {}, e.close_btn = e.close_btn || "OK", e.submit_btn = e.submit_btn || !1, e.close = e.close || hideAlert, e.submit = e.submit || e.close, hideAlert();
    var o = $('<div class="tl_popup tl_alert"><main class="tl_popup_body tl_alert_message"><section></section><aside class="tl_popup_buttons"></aside></main></div>');
    $("section", o).html(t);
    var l = $("aside", o);
    if (e.close_btn) {
        var r = $('<button class="button"></button>');
        r.html(e.close_btn).click(e.close).appendTo(l)
    }
    if (e.submit_btn) {
        var i = $('<button class="button"></button>');
        i.html(e.submit_btn).click(function() {
            o.addClass("tl_popup_loading"), e.submit()
        }).appendTo(l)
    }
    o.appendTo("body")
}
...
function showPopup(t) {
    hideAlert(), t.removeClass("tl_popup_hidden")
}
...
function isOverElement(t, e, o) {
    ...
    return !(t.left - r.right >= o || r.left - t.right >= o || t.top - r.bottom >= o || r.top - t.bottom >= o) && r
}
...
function tooltipUpdatePosition(t, e, o) {
    if (o = o || {
            padding: 10,
            position: "top"
        }, e = e || t._range || null, null != e) {
        var l = quill.getBounds(e),
            r = $(quill.container).offset(),
            i = {
                width: t.outerWidth(),
            ...
            s = {
                left: a.width - i.width - 9,
                top: a.scrolltop + a.height - i.height - 9
            };
        i.left = l.left + l.width / 2 - i.width / 2;
        var u = r.left + i.left;
        u < n.left ? i.left = n.left - r.left : u > s.left && (i.left = s.left - r.left);
        var c = void 0;
        if ("top" == o.position) {
            i.top = l.top - i.height - o.padding;
            var d = r.top + i.top;
            c = !1, d < n.top && (i.top = l.bottom + o.padding, c = !0)
        } else if ("bottom" == o.position) {
            var p = !1;
            i.top = l.bottom + o.padding, (p = isOverElement(i, o.depend, o.dependPadding)) && (i.top = p.bottom + o.dependPadding);
            var h = r.top + i.top;
            c = !0, h > s.top && (i.top = l.top - i.height - o.padding, (p = isOverElement(i, o.depend, o.dependPadding)) && (i.top = p.top - i.height - o.dependPadding), c = !1)
        }
        i.left = Math.round(i.left), i.top = Math.round(i.top), t._range = e, o.minDelta && Math.abs(i.left - t._left) < o.minDelta && Math.abs(i.top - t._top) < o.minDelta || (t._left = i.left, t._top = i.top, t.css({
            left: i.left,
            top: i.top
...
function blocksUpdatePosition(t) {
    if ("undefined" == typeof t && (t = quill.getSelection()), null != t && window.quill) {
...
function toolbarPrompt(t, e, o) {
    var l = $(".prompt_input", t),
        r = $(".close", t);
    l.val("").attr("placeholder", e), l.on("keydown", function(e) {
        var r = e.which || e.keyCode;
        if (27 == r) toolbarPromptHide(t);
        else if (13 == r) {
            var i = l.val();
            i && (o && o(i), e.preventDefault()), toolbarPromptHide(t)
        }
    }), l.on("blur", function() {
        toolbarPromptHide(t)
    }), r.on("click", function() {
        toolbarPromptHide(t)
    }), t.show().addClass("tooltip_prompt"), l.focus()
}

function toolbarPromptHide(t) {
    var e = $(".prompt_input", t),
        o = $(".close", t);
    e.off("keydown"), e.off("blur"), o.off("click"), t.show().removeClass("tooltip_prompt"), quill.focus()
}
var _slicedToArray = function() {
    ...
    List = Quill["import"]("formats/list"),
    ...
    LinkBlot = function(t) {
        ...
        return _inherits(e, t), _createClass(e, null, [{
            ...
            value: function(t) {
                ...
                var l = t.substr(0, 1);
                return "/" != l && "#" != l && "tg://" != t.substr(0, 5) && "mailto:" != t.substr(0, 7) && o.setAttribute("target", "_blank"), o
            }
        }, {
            key: "formats",
            value: function(t) {
            ...
            key: "sanitize",
            value: function(t) {
                return _sanitize(t, ["http", "https", "tg", "mailto"]) ? relativeUrl(t) : "about:blank"
            }
        }]), _createClass(e, [{
            key: "detach",
            value: function() {
...
BreakBlot.blotName = "textBreak", BreakBlot.tagName = "br", BreakBlot.className = "inline", Quill.register(BreakBlot);
var BlockAuto = function(t) {
        function e() {
            return _classCallCheck(this, e), _possibleConstructorReturn(this, (e.__proto__ || Object.getPrototypeOf(e)).apply(this, arguments))
        }
        return _inherits(e, t), _createClass(e, [{
            key: "optimize",
            value: function() {
                _get(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "optimize", this).call(this);
                var t = window.getComputedStyle(this.domNode).direction;
                "rtl" == t ? this.domNode.classList.add("dir_rtl") : this.domNode.classList.remove("dir_rtl")
            }
        }], [{
            key: "create",
            value: function(t) {
                var o = _get(e.__proto__ || Object.getPrototypeOf(e), "create", this).call(this, t);
                return o.setAttribute("dir", "auto"), o
            }
        }]), e
    }(Block),
    ListAuto = function(t) {
...
ListAuto.blotName = "list", ListAuto.defaultChild = "list-item", ListAuto.tagName = ["OL", "UL"], ListAuto.allowedChildren = [ListItem],
...
var SingleLineBlot = function(t) {
        ...
        return _inherits(e, t), _createClass(e, [{
            ...
            value: function(t) {
                t.children.forEach(function(t) {
                    t instanceof BreakBlot && t.replaceWith(Parchment.create("text", " "))
                }), _get(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "replace", this).call(this, t)
            }
        }, {
            key: "insertAt",
            value: function(t, o, l) {
                "undefined" != typeof l && "textBreak" == o ? _get(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "insertAt", this).call(this, t, "\n") : _get(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "insertAt", this).call(this, t, o, l)
            }
        }]), e
    }(BlockAuto),
    ...
    TitleBlot = function(t) {
        ...
        return _inherits(e, t), _createClass(e, [{
            key: "formatAt",
            value: function(t, o, l, r) {
                l === this.constructor.blotName && _get(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "formatAt", this).call(this, t, o, l, r)
            }
        }], [{
            key: "create",
            value: function(t) {
                var o = _get(e.__proto__ || Object.getPrototypeOf(e), "create", this).call(this, t);
                return o.setAttribute("data-placeholder", "Title"), o.setAttribute("data-label", "Title"), o
            }
        }]), e
    }(FieldBlot);
...
var AuthorBlot = function(t) {
    ...
    return _inherits(e, t), _createClass(e, [{
        key: "formatAt",
        value: function(t, o, l, r) {
            l === this.constructor.blotName ? _get(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "formatAt", this).call(this, t, o, l, r) : "link" === l && _get(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "formatAt", this).call(this, 0, this.length(), l, r)
        }
    }], [{
        key: "create",
        value: function(t) {
            var o = _get(e.__proto__ || Object.getPrototypeOf(e), "create", this).call(this, t);
            return o.setAttribute("data-placeholder", "Your name"), o.setAttribute("data-label", "Author"), o
        }
    }]), e
}(FieldBlot);
...
var HeaderBlot = function(t) {
    ...
    return _inherits(e, t), _createClass(e, [{
        ...
        value: function() {
            ...
            t = t.replace(/[\s_]+/g, "-"), t = t.replace(/(^-+|-+$)/g, ""), this.domNode.setAttribute("id", t)
        }
    }, {
        key: "formatAt",
        value: function(t, o, l, r) {
            ("bold" !== l && "italic" !== l && "code" !== l || !r) && _get(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "formatAt", this).call(this, t, o, l, r)
        }
    }]), e
}(SingleLineBlot);
...
var Paragraph = function(t) {
    function e() {
        return _classCallCheck(this, e), _possibleConstructorReturn(this, (e.__proto__ || Object.getPrototypeOf(e)).apply(this, arguments))
    }
    return _inherits(e, t), e
}(BlockAuto);
Paragraph.blotName = "block", Paragraph.tagName = "p", Quill.register(Paragraph);
...
BlockquoteBlot.blotName = "blockBlockquote", BlockquoteBlot.tagName = "blockquote", Quill.register(BlockquoteBlot);
...
var FigureBlot = function(t) {
    function e(t, o) {
        _classCallCheck(this, e);
        var l = _possibleConstructorReturn(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t));
        l.domWrapper = document.createElement("div"), l.domCursor = document.createElement("span"), l.domCaption = document.createElement("figcaption"), l.domWrapper.classList.add("figure_wrapper"), l.domCursor.classList.add("cursor_wrapper"), l.domCursor.setAttribute("contenteditable", "true"), l.domCaption.setAttribute("dir", "auto"), l.domCaption.classList.add("editable_text"), l.domCaption.setAttribute("data-placeholder", "Caption (optional)"), o.caption && (l.domCaption.innerText = o.caption), l.domNode.appendChild(l.domWrapper), l.domNode.appendChild(l.domCursor), l.domNode.appendChild(l.domCaption), setTimeout(function() {
            updateEditableText(l.domNode)
        }, 1);
        var r = !1;
        return o.image ? (l.appendImgNode(o.image), r = l.uploadData(o.image)) : o.video ? (l.appendVideoNode(o.video), r = l.uploadData(o.video)) : o.embed && l.appendIframeNode(o.embed), r && (l.domProgress = document.createElement("div"), l.domProgressBar = document.createElement("div"), l.domProgress.classList.add("file_progress"), l.domProgressBar.classList.add("file_progress_bar"), l.domWrapper.classList.add("loading"), l.domProgress.appendChild(l.domProgressBar), l.domWrapper.appendChild(l.domProgress), l.uploadFile(r)), $(l.domWrapper).click(function() {
            ...
            if (e == Keyboard.keys.BACKSPACE) {
                ...
                quill.deleteText(o, l.length(), Quill.sources.USER), quill.setSelection(o - 1, 0, Quill.sources.USER), t.preventDefault()
            } else if (e == Keyboard.keys.ENTER) {
                var r = l.offset(quill.scroll) + l.length();
                quill.focus(), quill.insertText(r, "\n", Quill.sources.USER), quill.setSelection(r, 0, Quill.sources.USER), t.preventDefault()
            }
            ...
            if (e == Keyboard.keys.ENTER) {
                ...
                var r = o.selection("getPos"),
                    i = o.val();
                if (r.start != r.end) i = i.substr(0, r.start) + i.substr(r.end), o.val(i).selection("setPos", {
                    start: i.length,
                    end: i.length
                });
                else if (r.end == i.length) {
                    var a = l.offset(quill.scroll) + l.length();
                    quill.focus(), quill.insertText(a, "\n", Quill.sources.USER), quill.setSelection(a, 0, Quill.sources.USER)
                }
                t.preventDefault()
                ...
                if (n.start == n.end && n.end == s.length) {
                    ...
                    quill.focus(), quill.setSelection(u, 0, Quill.sources.USER), t.preventDefault()
                }
    ...
    return _inherits(e, t), _createClass(e, null, [{
        ...
        value: function(t) {
            ...
            return e.setAttribute("src", this.sanitize(t)), e.setAttribute("preload", "auto"), e.setAttribute("controls", "controls"), e.addEventListener("loadeddata", function() {
                this.mozHasAudio || this.webkitAudioDecodedByteCount || this.audioTracks && this.audioTracks.length || (this.setAttribute("autoplay", "autoplay"), this.setAttribute("loop", "loop"), this.setAttribute("muted", "muted"), this.removeAttribute("controls"), this.play())
            }), this.domWrapper.appendChild(e), e
        }
    }, {
        ...
        value: function(t) {
            ...
            return e.classList.add("iframe_wrap"), e.appendChild(o), o.classList.add("iframe_helper"), o.style.paddingTop = "56.25%", o.appendChild(l), l.setAttribute("src", this.sanitize(t)), l.setAttribute("width", "640"), l.setAttribute("height", "360"), l.setAttribute("frameborder", "0"), l.setAttribute("allowtransparency", "true"), l.setAttribute("allowfullscreen", "true"), l.setAttribute("scrolling", "no"), this.domWrapper.appendChild(e), e
        }
    }, {
        key: "uploadFile",
        value: function(t) {
            ...
            _uploadFile(t, function(t, o) {
                var l = 0;
                o && t && (l = 100 * t / o, l = Math.min(100, l)), e.domProgressBar.style.width = l + "%"
            }, function(o) {
                if (o) {
                    var l = e.sanitize(o.src);
                    if ("video/" == t.type.substr(0, 6)) {
                        var r = e.domWrapper.querySelector("video");
                        r.setAttribute("src", l)
                    } else {
                        var i = e.domWrapper.querySelector("img");
                        i.setAttribute("src", l)
                    }
                    e.domWrapper.classList.remove("loading"), draftSave()
                }
            }, function(t) {
                return quill.deleteText(e.offset(quill.scroll), e.length(), Quill.sources.SILENT), draftSave(), showError(t)
            })
        }
    }, {
        key: "uploadData",
        ...
        value: function(t, e) {
            ...
            for (var o = t.firstChild; o;) {
                var l = null,
                    r = this._position(o, e),
                    i = _slicedToArray(r, 2);
                if (l = i[0], e = i[1], l) return [l, e];
                o = o.nextSibling
            }
            return [t, e]
        }
        ...
        value: function o(t) {
            ...
            if (i) {
                var a = i.querySelector(".editable_input");
                a ? o.caption = a.value : o.caption = i.innerText
            }
            return o
        }
    }]), e
...
var MyQuill = function(t) {
        ...
        return _inherits(e, t), _createClass(e, [{
            key: "formatLine",
            value: function() {
                for (var t, o = arguments.length, l = Array(o), r = 0; r < o; r++) l[r] = arguments[r];
                (t = _get(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "formatLine", this)).call.apply(t, [this].concat(l)), this.updateSelection()
            }
        }, {
            key: "formatText",
            value: function() {
                for (var t, o = arguments.length, l = Array(o), r = 0; r < o; r++) l[r] = arguments[r];
                (t = _get(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "formatText", this)).call.apply(t, [this].concat(l)), this.updateSelection()
            }
        }, {
            key: "updateSelection",
            value: function(t) {
                if (this.hasFocus()) {
                    ...
                    this.setSelection(++e.index, e.length, t), this.setSelection(--e.index, e.length, t)
                }
            }
        }]), e
    }(Quill),
    $tl_page = $(".tl_page"),
    $tl_page_footer = $(".tl_page_footer"),
    ...
    $report_button = $("#_report_button"),
    $report_popup = $("#_report_popup"),
    $report_form = $("#_report_form"),
    $report_cancel = $("#_report_cancel"),
    formatTTOptions = {
        padding: 10,
...
$tl_tooltip.mouseover(function(t) {
    var e = t.target;
    "BUTTON" != t.target.tagName || t.target.classList.contains("disabled") || ($tl_tooltip.attr("data-hover", e.id).addClass("hover"), setTimeout(function() {
        $tl_tooltip.addClass("hover_anim")
    }, 1), clearTimeout($tl_tooltip.to))
}), $tl_tooltip.mouseout(function(t) {
    var e = t.target;
    "BUTTON" == e.tagName && ($tl_tooltip.removeClass("hover"), $tl_tooltip.to = setTimeout(function() {
    ...
    if (o) {
        var r = quill.scroll.descendants(LinkBlot, l.index, l.length);
        r.forEach(function(t) {
            var e = t.offset(quill.scroll),
                o = t.length();
            quill.formatText(e, o, "link", !1)
        }), toolbarUpdate(l)
    } else toolbarPrompt($tl_tooltip, "Paste or type a link...", function(t) {
        t = t.trim(), "#" != t.substr(0, 1) && "/" != t.substr(0, 1) && "http://" != t.substr(0, 7) && "https://" != t.substr(0, 8) && "tg://" != t.substr(0, 5) && "mailto:" != t.substr(0, 7) && (t = t.indexOf("@") > 0 ? "mailto:" + t : "http://" + t), quill.focus(), quill.format("link", t), toolbarUpdate(l)
    })
    ...
    var r = quill.scroll.descendants(HeaderBlot, l.index, l.length);
    r.forEach(function(t) {
        var e = t.offset(quill.scroll),
            o = t.length();
    ...
    var r = quill.scroll.descendants(SubheaderBlot, l.index, l.length);
    r.forEach(function(t) {
        var e = t.offset(quill.scroll),
            o = t.length();
        quill.formatText(e, o, {
    ...
    t.preventDefault();
    quill.getSelection(!0);
    o ? quill.format("blockPullquote", !l) : quill.format("blockBlockquote", !0), quill.updateSelection(Quill.sources.API)
}), $image_button.click(function() {
    var t = quill.container.querySelector("input.ql-image[type=file][data-status=ready]");
    null == t && (t = document.createElement("input"), t.setAttribute("type", "file"), t.setAttribute("accept", browser.safari_mobile ? "image/gif, image/jpeg, image/jpg, image/png" : "image/gif, image/jpeg, image/jpg, image/png, video/mp4"), t.classList.add("ql-image"), t.addEventListener("change", function() {
        if (null != t.files && null != t.files[0]) {
            var e = t.files[0];
            updatePhoto(e, function(e) {
                if (quill.fileSizeLimit && e.size > quill.fileSizeLimit) return quill.fileSizeLimitCallback && quill.fileSizeLimitCallback();
    ...
    }), quill.container.appendChild(t)), t.setAttribute("data-status", "busy"), t.click()
    ...
    var e = quill.getSelection(!0),
        ...
        r = l[0];
    if (r) {
        var i = $(r.domNode).text();
        i || (r.domNode.setAttribute("data-placeholder", "Paste a YouTube, Vimeo or Twitter link, and press Enter"), $(r.domNode).addClass("placeholder_once empty"), hideBlocksTooltip())
    }
    ...
    var t = $report_form.get(0);
    t.reset(), updateReportFormState(), showPopup($report_popup)
}), $report_form.submit(function(t) {
    t.preventDefault(), sendReport()
