! function(t, e) {
    ...
    return function(t) {
            ...
            s = function(t) {
                ...
                return o(e, t), e.prototype.appendChild = function(t) {
                    ...
                    t.forEach(function(t) {
                        ...
                        if (!(null != t.parentNode && document.body.compareDocumentPosition(t) & Node.DOCUMENT_POSITION_CONTAINED_BY)) {
                            var n = a.find(t);
        ...
        function o(t, e) {
            ...
            else if ("number" == typeof t) t & p.LEVEL & p.BLOCK ? n = f.block : t & p.LEVEL & p.INLINE && (n = f.inline);
        ...
        function a(t, e, n, r) {
            ...
            var o = null == n ? null : this.getSelection(),
                i = this.editor.delta,
                l = t();
            if (null != o && (n === !0 && (n = o.index), null == r ? o = u(o, l, e) : 0 !== r && (o = u(o, n, r, e)), this.setSelection(o, g["default"].sources.SILENT)), l.length() > 0) {
        ...
        function s(t, e, n, r, o) {
            var i = {};
            return "number" == typeof t.index && "number" == typeof t.length ? "number" != typeof e ? (o = r, r = n, n = e, e = t.length, t = t.index) : (e = t.length, t = t.index) : "number" != typeof e && (o = r, r = n, n = e, e = 0), "object" === ("undefined" == typeof n ? "undefined" : c(n)) ? (i = n, o = r) : "string" == typeof n && (null != r ? i[n] = r : o = n), o = o || g["default"].sources.API, [t, e, i, o]
        }
        ...
        var h = n(20),
            ...
            S = function() {
                function t(e) {
                    ...
                    this.options.debug && t.debug(this.options.debug), this.fileSizeLimit = this.options.fileSizeLimit, this.fileSizeLimitCallback = this.options.fileSizeLimitCallback, this.updatePhoto = this.options.updatePhoto || function(t, e) {
                        e && e(t)
                    };
                    var o = this.container.innerHTML.trim();
                    this.container.classList.add("ql-container"), this.container.innerHTML = "", this.root = this.addContainer("ql-editor"), this.root.classList.add("ql-blank"), this.emitter = new g["default"], this.scroll = w["default"].create(this.root, {
                ...
                return p(t, null, [{
                    ...
                    value: function(t, e) {
                        ...
                        } else null != this.imports[t] && !r, this.imports[t] = e, (t.startsWith("blots/") || t.startsWith("formats/")) && "abstract" !== e.blotName && w["default"].register(e);
                    }
                }]), p(t, [{
                    key: "addContainer",
                    value: function(t) {
                    ...
                    value: function() {
                        ...
                        this.scroll.enable(t), this.container.classList.toggle("ql-disabled", !t), t || this.blur()
                    }
                }, {
                    key: "focus",
                    value: function() {
        ...
        S.DEFAULTS = {
            ...
            strict: !0,
            theme: "default"
        }, S.events = g["default"].events, S.sources = g["default"].sources, S.version = "1.1.3", S.imports = {
            delta: d["default"],
            parchment: w["default"],
        ...
        s.prototype.insert = function(t, e) {
            var n = {};
            return 0 === t.length ? this : (n.insert = t, e instanceof Object && Object.keys(e).length > 0 && (n.attributes = e), this.push(n))
            ...
            return e instanceof Object && Object.keys(e).length > 0 && (n.attributes = e), this.push(n)
            ...
            var n = [this, t].map(function(e) {
                    return e.map(function(e) {
                        if (null != e.insert) return "string" == typeof e.insert ? e.insert : a;
                        var n = ops === t.ops ? "on" : "with";
            ...
            e = e || "\n";
            for (var n = l.iterator(this.ops), r = new s; n.hasNext();) {
                if ("insert" !== n.peekType()) return;
                var o = n.peek(),
                    i = l.length(o) - n.peekLength(),
                    a = "string" == typeof o.insert ? o.insert.indexOf(e, i) - i : -1;
                a < 0 ? r.push(n.next()) : a > 0 ? r.push(n.next(a)) : (t(r, n.next(1).attributes || {}), r = new s)
            }
            r.length() > 0 && t(r, {})
        ...
        function s(t, e) {
            ...
            var c, f, p, h;
            t.length > e.length ? (c = i[0], f = i[1], p = i[2], h = i[3]) : (p = i[0], h = i[1], c = i[2], f = i[3]);
            var d = i[4];
            return [c, f, p, h, d]
        }
        ...
        t.exports = function l() {
            var t, e, n, r, a, s, u = arguments[0],
                ...
                f = arguments.length,
                p = !1;
            for ("boolean" == typeof u ? (p = u, u = arguments[1] || {}, c = 2) : ("object" != typeof u && "function" != typeof u || null == u) && (u = {}); c < f; ++c)
                if (t = arguments[c], null != t)
                    for (e in t) n = u[e], r = t[e], u !== r && (p && r && (i(r) || (a = o(r))) ? (a ? (a = !1, s = n && o(n) ? n : []) : s = n && i(n) ? n : {}, u[e] = l(p, s, r)) : "undefined" != typeof r && (u[e] = r));
            return u
        }
    }, function(t, e, n) {
        function r(t) {
        ...
        function a(t) {
            return t.reduce(function(t, e) {
                ...
                if (null == e.attributes || e.attributes.list !== !0 && e.attributes.bullet !== !0 || (e = (0, k["default"])(e), e.attributes.list ? e.attributes.list = "ordered" : (e.attributes.list = "bullet", delete e.attributes.bullet)), "string" == typeof e.insert) {
                ...
                return c(t, [{
                            ...
                            if (null != o.insert) {
                                if ("string" == typeof o.insert) {
                                    ...
                                    if (p instanceof w["default"]) {
                                        var b = p.descendant(v["default"].Leaf, h),
                                            g = u(b, 1),
                                            m = g[0];
                    ...
                    value: function(t, e) {
                        ...
                        var c = this.getContents(t, e + a),
                            f = c.diff((new p["default"]).insert(n).concat(s)),
                    ...
                    value: function(t) {
                        var e = this,
                            ...
                            o = this.delta;
                        return 1 === n.length && "characterData" === n[0].type && v["default"].find(n[0].target) ? ! function() {
                            var i = v["default"].find(n[0].target),
                                l = (0, O.bubbleFormats)(i),
                                a = i.offset(e.scroll),
                                s = n[0].oldValue.replace(_["default"].CONTENTS, ""),
                                u = (new p["default"]).insert(s),
                                c = (new p["default"]).insert(i.value()),
                                f = (new p["default"]).retain(a).concat(u.diff(c, r));
                            t = f.reduce(function(t, e) {
                                return e.insert ? t.insert(e.insert, l) : t.push(e)
                            }, new p["default"]), e.delta = o.compose(t)
                        }() : (this.delta = this.getDelta(), t && (0, j["default"])(o.compose(t), this.delta) || (t = o.diff(this.delta, r))), t
                    }
                }]), t
            }();
        e["default"] = q
        ...
        var a = function() {
            ...
            f = function(t) {
                ...
                return l(e, t), a(e, [{
                    key: "insertInto",
                    value: function(t, n) {
                        0 === t.children.length ? s(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "insertInto", this).call(this, t, n) : this.remove()
                    }
                }, {
                    key: "length",
                    value: function() {
        ...
        Object.create && (n.prototype = Object.create(null), (new n).__proto__ || (l = !1)), o.prototype.eventNames = function() {
            ...
            return this
        }, o.prefixed = l, o.EventEmitter = o, "undefined" != typeof t && (t.exports = o)
    }, function(t, e) {
        "use strict";
        ...
        var n = function() {
            ...
            function t(e, n, r, o) {
                function a(e, r) {
                    ...
                    if (e instanceof l) c = new l;
                    else if (e instanceof s) c = new s;
                    else if (e instanceof u) c = new u(function(t, n) {
                        e.then(function(e) {
                            t(a(e, r - 1))
                        }, function(t) {
                            n(a(t, r - 1))
                    ...
                    else if (t.__isArray(e)) c = [];
                    else if (t.__isRegExp(e)) c = new RegExp(e.source, i(e)), e.lastIndex && (c.lastIndex = e.lastIndex);
                    else if (t.__isDate(e)) c = new Date(e.getTime());
                    else {
                        if (h && Buffer.isBuffer(e)) return c = new Buffer(e.length), e.copy(c), c;
                        "undefined" == typeof o ? (d = Object.getPrototypeOf(e), c = Object.create(d)) : (c = Object.create(o), d = o)
                    }
                    if (n) {
                        var y = f.indexOf(e);
                        if (y != -1) return p[y];
                    ...
                    for (var w in e) {
                        var x;
                        d && (x = Object.getOwnPropertyDescriptor(d, w)), x && null == x.set || (c[w] = a(e[w], r - 1))
                    }
                    if (Object.getOwnPropertySymbols)
                        for (var k = Object.getOwnPropertySymbols(e), w = 0; w < k.length; w++) {
                            var E = k[w];
                            c[E] = a(e[E], r - 1)
                        }
                    return c
                ...
                var c;
                "object" == typeof n && (r = n.depth, o = n.prototype, c = n.filter, n = n.circular);
                var f = [],
                    p = [],
                    h = "undefined" != typeof Buffer;
                return "undefined" == typeof n && (n = !0), "undefined" == typeof r && (r = 1 / 0), a(e, r)
            }
        ...
        var a = function() {
            ...
            _ = function w(t) {
                var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0;
                i(this, w), this.index = t, this.length = e
            },
            O = function() {
                function t(e, n) {
                    var r = this;
                ...
                return s(t, [{
                    ...
                    value: function() {
                        if (!this.hasFocus()) {
                            ...
                            this.root.focus(), document.documentElement.scrollTop = t, this.setRange(this.savedRange)
                        }
                    }
                }, {
                    key: "format",
                    ...
                    value: function(t) {
                        ...
                        if (e > 0) {
                            ...
                            var y = s.position(u, !0),
                                v = a(y, 2);
                            o = v[0], u = v[1], p.setEnd(o, u), r = p.getBoundingClientRect()
                        } else {
                            var b = "left",
                                g = void 0;
                            o instanceof Text ? (u < o.data.length ? (p.setStart(o, u), p.setEnd(o, u + 1)) : (p.setStart(o, u - 1), p.setEnd(o, u), b = "right"), g = p.getBoundingClientRect()) : (g = s.domNode.getBoundingClientRect(), u > 0 && (b = "right")), r = {
                                height: g.height,
                                left: g[b],
                                width: 0,
                                top: g.top
                    ...
                    value: function() {
                        ...
                        if (null != t) {
                            ...
                            if (null != e) {
                                var n = function(t) {
                                        for (var e = t.offsetTop; t = t.offsetParent;) e += t.offsetTop;
                                        return e
                                    },
                                    r = n(this.root),
                                    o = e.top + r - document.documentElement.scrollTop,
                                    i = e.bottom + r - document.documentElement.scrollTop,
                                    l = Math.round(window.innerHeight / 5);
                                if (window.innerHeight < i) {
                                    var s = this.scroll.line(Math.min(t.index + t.length, this.scroll.length() - 1)),
                                        u = a(s, 1),
                                        c = u[0];
                                    document.documentElement.scrollTop = c.domNode.offsetTop + c.domNode.offsetHeight + r - window.innerHeight + l
                                } else if (o < 0) {
                                    var f = this.scroll.line(Math.min(t.index, this.scroll.length() - 1)),
                                        p = a(f, 1),
                                        h = p[0];
                                    document.documentElement.scrollTop = h.domNode.offsetTop + r - l
                                }
                            }
                        }
                    }
                            ...
                            if (null != i)
                                if (null != t) {
                                    if (!this.hasFocus()) {
                                        ...
                                        this.root.focus(), document.documentElement.scrollTop = l
                                    }
                                    var a = this.getNativeRange();
                                    if (null == a || o || t !== a.start.node || e !== a.start.offset || n !== a.end.node || r !== a.end.offset) {
                    ...
                    value: function(t) {
                        ...
                        "string" == typeof n && (r = n, n = !1), m.info("setRange", t), null != t ? ! function() {
                    ...
                    value: function() {
                        ...
                        if (this.lastRange = o[0], e = o[1], null != this.lastRange && (this.savedRange = this.lastRange), !(0, d["default"])(n, this.lastRange)) {
                            ...
                            var l = [v["default"].events.SELECTION_CHANGE, (0, p["default"])(this.lastRange), (0, p["default"])(n), t];
                            if ((i = this.emitter).emit.apply(i, [v["default"].events.EDITOR_CHANGE].concat(l)), t !== v["default"].sources.SILENT) {
                                var s;
                        ...
                        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0,
                            ...
                            n = function r(t, e, n) {
                                ...
                                return t.children.forEachAt(e, n, function(t, e, n) {
                                    a(t) ? o.push(t) : t instanceof p["default"].Container && (o = o.concat(r(t, e, i))), i -= n
                                }), o
                            };
                        return n(this, t, e)
                    }
        ...
        function h(t, e) {
            ...
            return n.concat(r).concat(o).forEach(function(e) {
                ...
                null != n && (i[n.attrName] = n.value(t), i[n.attrName]) || (null != H[e] && (n = H[e], i[n.attrName] = n.value(t)), null != F[e] && (n = F[e], i[n.attrName] = n.value(t)))
        ...
        function g(t, e) {
            if (f(t) && null != t.nextElementSibling && !c(e, "\n\n")) {
                var n = u(t),
                    r = Math.max(0, parseFloat(n.marginTop)),
                    o = parseFloat(n.marginBottom),
                    i = t.offsetHeight + r + o;
                t.nextElementSibling.offsetTop > t.offsetTop + 1.5 * i && e.insert("\n")
            }
            return e
        }
        ...
        var O = function() {
            ...
            H = [L.AlignAttribute, R.DirectionAttribute].reduce(function(t, e) {
                return t[e.keyName] = e, t
            }, {}),
            F = [L.AlignStyle, C.BackgroundStyle, M.ColorStyle, R.DirectionStyle, I.FontStyle, B.SizeStyle].reduce(function(t, e) {
                return t[e.keyName] = e, t
            }, {}),
            z = function(t) {
                function e(t, n) {
                ...
                return s(e, t), w(e, [{
                    ...
                    value: function(t, e) {
                        var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : N["default"].sources.API;
                        if ("string" == typeof t) return this.quill.setContents(this.convert(t), e);
                        var r = this.convert(e);
                        return this.quill.updateContents((new k["default"]).retain(t).concat(r), n)
                    }
                }, {
                    key: "onPaste",
                    value: function(t) {
                        ...
                        if (!t.defaultPrevented && this.quill.isEnabled()) {
                            var n, r = this.quill.getSelection(),
                                o = this.quill.getBounds(r),
                                i = (new k["default"]).retain(r.index)["delete"](r.length),
                                l = !1,
                                a = document.documentElement.scrollTop,
                                s = function(t) {
                                    e.container.focus(), e.quill.selection.update(N["default"].sources.SILENT), i = i.concat(t), e.quill.updateContents(i, N["default"].sources.USER), e.quill.setSelection(i.length() - r.length, N["default"].sources.SILENT), document.documentElement.scrollTop = a, e.quill.selection.scrollIntoView(), e.quill.emitter.emit(e.quill.emitter.constructor.events.TEXT_PASTE, i, N["default"].sources.USER)
                                };
                            if ("undefined" != typeof t.clipboardData && (n = t.clipboardData.items))
                                for (var u = 0; u < n.length; u++)
                                    if ("file" == n[u].kind && 0 == n[u].type.indexOf("image/")) {
                                        var c = n[u].getAsFile();
                                        e.quill.updatePhoto(c, function(t) {
                                            if (e.quill.fileSizeLimit && t.size > e.quill.fileSizeLimit) return void(e.quill.fileSizeLimitCallback && e.quill.fileSizeLimitCallback());
                                            var n = new FileReader;
                                            n.onload = function(t) {
                                                var n = document.createElement("img");
                                                n.src = t.target.result, s(e.convert(n.outerHTML))
                                            }, n.readAsDataURL(t)
                                        }), t.preventDefault(), l = !0;
                                        break
                                    }
                            l || (this.container.style.top = o.top + "px", this.container.focus(), setTimeout(function() {
                                s(e.convert())
                            }, 1))
                        }
                    }
        ...
        z.DEFAULTS = {
            matchers: []
        }, e["default"] = z, e.matchAttributor = h, e.matchBlot = d, e.matchNewline = b, e.matchSpacing = g, e.matchText = _
    }, function(t, e, n) {
        "use strict";
        ...
        var a = function() {
            ...
            p = new c["default"].Attributor.Class("color", "ql-color", {
                scope: c["default"].Scope.INLINE
            }),
            h = new f("color", "color", {
                scope: c["default"].Scope.INLINE
            });
        e.ColorAttributor = f, e.ColorClass = p, e.ColorStyle = h
    }, function(t, e, n) {
        "use strict";
        ...
        var a = function() {
            ...
            p = new c["default"].Attributor.Class("font", "ql-font", f),
            h = function(t) {
                function e() {
                    return o(this, e), i(this, (e.__proto__ || Object.getPrototypeOf(e)).apply(this, arguments))
                }
                return l(e, t), a(e, [{
                    key: "value",
                    value: function(t) {
                        return s(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "value", this).call(this, t).replace(/["']/g, "")
                    }
                }]), e
            }(c["default"].Attributor.Style),
            d = new h("font", "font-family", f);
        e.FontStyle = d, e.FontClass = p
    }, function(t, e, n) {
        "use strict";
        ...
        function a(t, e) {
            if (0 !== t.index) {
                var n = this.quill.scroll.line(t.index),
                    r = y(n, 1),
                    o = r[0],
                    i = {};
                if (0 === e.offset) {
                    ...
                    i = k["default"].attributes.diff(l, a) || {}
                }
                this.quill.deleteText(t.index - 1, 1, N["default"].sources.USER), Object.keys(i).length > 0 && this.quill.formatLine(t.index - 1, 1, i, N["default"].sources.USER), this.quill.selection.scrollIntoView()
            }
        }

        function s(t) {
            t.index >= this.quill.getLength() - 1 || this.quill.deleteText(t.index, 1, N["default"].sources.USER)
        }
        ...
        function c(t, e) {
            ...
            this.quill.insertText(t.index, "\n", r, N["default"].sources.USER), this.quill.selection.scrollIntoView(), Object.keys(e.format).forEach(function(t) {
        ...
        function f(t) {
            return {
                ...
                handler: function(e) {
                    var n = j["default"].query("code-block"),
                        r = e.index,
                        o = e.length,
        ...
        function h(t) {
            ...
            if ("object" === ("undefined" == typeof t ? "undefined" : d(t)) && (t = (0, g["default"])(t, !1)), "string" == typeof t.key)
            ...
            M = function(t) {
                function e(t, n) {
                    ...
                    return r.bindings = {}, Object.keys(r.options.bindings).forEach(function(t) {
                        ...
                        collapsed: !1
                    }, u), /Trident/i.test(navigator.userAgent) && (r.addBinding({
                        key: e.keys.BACKSPACE,
                        shortKey: !0
                    }, a), r.addBinding({
                        key: e.keys.DELETE,
                ...
                return l(e, t), v(e, null, [{
                    key: "match",
                    value: function(t, e) {
                        return e = h(e), (!!e.shortKey === t[C] || null === e.shortKey) && (!["altKey", "ctrlKey", "metaKey", "shiftKey"].some(function(n) {
                            return n != C && !!e[n] !== t[n] && null !== e[n]
                    ...
                    value: function(t) {
                        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                            ...
                            r = h(t);
                        return null == r || null == r.key ? L.warn("Attempted to add invalid keyboard binding", r) : ("function" == typeof e && (e = {
                            handler: e
                        }), "function" == typeof n && (n = {
                            handler: n
                        }), r = (0, w["default"])(r, e, n), this.bindings[r.key] = this.bindings[r.key] || [], void this.bindings[r.key].push(r))
                    }
                }, {
                    key: "listen",
                    value: function() {
                                ...
                                if (0 !== o.length) {
                                    ...
                                    if (null != i && t.quill.hasFocus()) {
                                        var l = t.quill.scroll.line(i.index),
                                            ...
                                            p = f[0],
                                            h = f[1],
                                            v = 0 === i.length ? [p, h] : t.quill.scroll.leaf(i.index + i.length),
                                            b = y(v, 2),
                                            g = b[0],
                                            m = b[1],
                                            O = p instanceof j["default"].Text ? p.value().slice(0, h) : "",
                                            w = g instanceof j["default"].Text ? g.value().slice(m) : "",
                                            x = {
                                            ...
                                            k = o.some(function(e) {
                                                ...
                                                if (Array.isArray(e.format)) {
                                                    if (e.format.every(function(t) {
                                                        ...
                                                        return e.format[t] === !0 ? null != x.format[t] : e.format[t] === !1 ? null == x.format[t] : (0, _["default"])(e.format[t], x.format[t])
                                                    })) return !1;
                                                return !(null != e.prefix && !e.prefix.test(x.prefix)) && (!(null != e.suffix && !e.suffix.test(x.suffix)) && e.handler.call(t, i, x) !== !0)
                                            });
                                        k && n.preventDefault()
                                    }
                                }
            ...
            bindings: {
                ...
                indent: {
                    ...
                    handler: function(t, e) {
                        return !(!e.collapsed || 0 === e.offset) || void this.quill.format("indent", "+1", N["default"].sources.USER)
                    }
                },
                outdent: {
                    key: M.keys.TAB,
                ...
                "list autofill": {
                    ...
                    handler: function(t, e) {
                        ...
                        this.quill.scroll.deleteAt(t.index - n, n), this.quill.formatLine(t.index - n, 1, "list", 1 === n ? "bullet" : "ordered", N["default"].sources.USER), this.quill.setSelection(t.index - n, N["default"].sources.SILENT)
                    }
                }
            }
        }, e["default"] = M
        ...
        p.blotName = "link", p.tagName = "A", p.SANITIZED_URL = "about:blank", e["default"] = p, e.sanitize = a
    }, function(t, e, n) {
        "use strict";
        ...
        var a = function() {
            ...
            h = function(t) {
                ...
                return l(e, t), a(e, [{
                    key: "format",
                    value: function(t, n) {
                        p.indexOf(t) > -1 ? n ? this.domNode.setAttribute(t, n) : this.domNode.removeAttribute(t) : s(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "format", this).call(this, t, n)
                    }
                }], [{
                    key: "create",
                    value: function(t) {
        ...
        k.DEFAULTS = {}, k.DEFAULTS = {
            ...
            handlers: {
                ...
                link: function(t) {
                    t === !0 && (t = prompt("Enter link URL:")), this.quill.format("link", t, g["default"].sources.USER)
                },
                indent: function E(t) {
                    var e = this.quill.getSelection(),
                    ...
                    if ("+1" === t || "-1" === t) {
                        var r = "+1" === t ? 1 : -1;
                        "rtl" === n.direction && (r *= -1), this.quill.format("indent", E + r, g["default"].sources.USER)
                    }
                }
            }
        ...
        var i = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t) {
            ...
            u = function() {
                function t(e) {
                    var n = this;
                    o(this, t), this.select = e, this.container = document.createElement("span"), this.buildPicker(), this.select.style.display = "none", this.select.parentNode.insertBefore(this.container, this.select), this.label.addEventListener("click", function() {
        ...
        var r = function() {
            ...
            o = function() {
                function t(e, r) {
                    var o = this;
                    n(this, t), this.quill = e, this.boundsContainer = r || document.body, this.root = e.addContainer("ql-tooltip"), this.root.innerHTML = this.constructor.TEMPLATE;
        ...
        var a = function m(t, e, n) {
            ...
            b = function(t) {
                ...
                return l(e, t), s(e, [{
                    key: "extendToolbar",
                    value: function(t) {
                        this.tooltip = new g(this.quill, this.options.bounds), this.tooltip.root.appendChild(t.container), this.buildButtons([].slice.call(t.container.querySelectorAll("button"))), this.buildPickers([].slice.call(t.container.querySelectorAll("select")))
                    }
                }]), e
            }(d["default"]);
        b.DEFAULTS = (0, c["default"])(!0, {}, d["default"].DEFAULTS, {
            modules: {
                toolbar: {
                    handlers: {
                        link: function(t) {
        ...
        var g = function(t) {
            function e(t, n) {
                o(this, e);
                var r = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n));
                return r.quill.on(p["default"].events.EDITOR_CHANGE, function(t, e) {
                    if (t === p["default"].events.SELECTION_CHANGE)
                        if (null != e && e.length > 0) {
                            ...
                            if (1 === n.length) r.position(r.quill.getBounds(e));
                                ...
                                var o = n[n.length - 1],
                                    ...
                                    a = r.quill.getBounds(new y.Range(i, l));
                                r.position(a)
                            }
        ...
        g.TEMPLATE = ['<span class="ql-tooltip-arrow"></span>', '<div class="ql-tooltip-editor">', '<input type="text" data-formula="e=mc^2" data-link="quilljs.com" data-video="Embed URL">', '<a class="ql-close"></a>', "</div>"].join(""), e["default"] = b
    }, function(t, e, n) {
        "use strict";
                    ...
                    value: function(t) {
                        ...
                        this.pickers = t.map(function(t) {
                            ...
                            if (t.classList.contains("ql-background") || t.classList.contains("ql-color")) {
                                ...
                                return null == t.querySelector("option") && a(t, P, "background" === e ? "#ffffff" : "#000000"), new O["default"](t, q["default"][e])
                            }
                            return null == t.querySelector("option") && (t.classList.contains("ql-font") ? a(t, S) : t.classList.contains("ql-header") ? a(t, L) : t.classList.contains("ql-size") && a(t, C)), new E["default"](t)
                        });
                        var n = function() {
                ...
                toolbar: {
                    handlers: {
                        ...
                        image: function() {
                            ...
                            null == e && (e = document.createElement("input"), e.setAttribute("type", "file"), e.setAttribute("accept", "image/*"), e.classList.add("ql-image"), e.addEventListener("change", function() {
                                if (null != e.files && null != e.files[0]) {
                                    var n = e.files[0];
                                    t.quill.updatePhoto(n, function(n) {
                                        if (t.quill.fileSizeLimit && n.size > t.quill.fileSizeLimit) return void(t.quill.fileSizeLimitCallback && t.quill.fileSizeLimitCallback());
                                        ...
                                        r.onload = function(n) {
                                            ...
                                            }), y["default"].sources.USER), e.value = ""
                                        }, r.readAsDataURL(n)
                                    })
                                }
        ...
        var a = function() {
            ...
            _ = function(t) {
                function e(t, n) {
                    o(this, e), null != n.modules.toolbar && null == n.modules.toolbar.container && (n.modules.toolbar.container = m);
                    var r = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n));
                ...
                return l(e, t), u(e, [{
                    key: "extendToolbar",
                    value: function(t) {
                        t.container.classList.add("ql-snow"), this.buildButtons([].slice.call(t.container.querySelectorAll("button"))), this.buildPickers([].slice.call(t.container.querySelectorAll("select"))), this.tooltip = new O(this.quill, this.options.bounds), t.container.querySelector(".ql-link") && this.quill.keyboard.addBinding({
                            key: "K",
                            shortKey: !0
                        }, function(e, n) {
        ...
        _.DEFAULTS = (0, f["default"])(!0, {}, y["default"].DEFAULTS, {
            modules: {
                toolbar: {
                    handlers: {
                        link: function(t) {
            ...
            return l(e, t), u(e, [{
                ...
                value: function() {
                    ...
                    s(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "listen", this).call(this), this.root.querySelector("a.ql-action").addEventListener("click", function(e) {
                        ...
                        null != t.linkRange && (t.restoreFocus(), t.quill.formatText(t.linkRange, "link", !1, h["default"].sources.USER), delete t.linkRange), e.preventDefault(), t.hide()
                    }), this.quill.on(h["default"].events.SELECTION_CHANGE, function(e) {
                        if (null != e) {
                            if (0 === e.length) {
                                var n = t.quill.scroll.descendant(b["default"], e.index),
                                    ...
                                    i = r[1];
                                if (null != o) {
                                    t.linkRange = new g.Range(e.index - i, o.length());
        ...
        O.TEMPLATE = ['<a class="ql-preview" target="_blank" href="about:blank"></a>', '<input type="text" data-formula="e=mc^2" data-link="quilljs.com" data-video="Embed URL">', '<a class="ql-action"></a>', '<a class="ql-remove"></a>'].join(""), e["default"] = _
    }])
});